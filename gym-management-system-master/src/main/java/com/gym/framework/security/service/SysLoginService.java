package com.gym.framework.security.service;
...
import com.gym.common.exception.user.CaptchaExpireException;
...
import com.gym.framework.redis.RedisCache;
import com.gym.framework.security.LoginUser;
...
public class SysLoginService
{
    ...
    public void validateCaptcha(String username, String code, String uuid)
    {
        ...
        System.out.println("验证码：" + captcha + "，用户输入的验证码：" + code);
        if (captcha == null)
        {
