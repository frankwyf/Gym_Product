...
import { buildLoginFormFromCookies, persistLoginCookies } from './login.helpers'
...
export default {
  ...
  methods: {
    ...
    getCookie() {
      this.loginForm = buildLoginFormFromCookies(this.loginForm, Cookies, decrypt);
    },
    handleLogin() {
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          this.loading = true;
          persistLoginCookies(this.loginForm, Cookies, encrypt)
...
.login {
  ...
  align-items: center;
  height: 100%;
  background-image: url("../assets/images/rongcheng.jpg");
