<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item :label="$tr('dict.name')" prop="dictName">
        <el-input
          v-model="queryParams.dictName"
          :placeholder="$tr('dict.placeholderName')"
          clearable
          size="small"
          style="width: 240px"
      ...
      <el-form-item :label="$tr('dict.type')" prop="dictType">
        <el-input
          v-model="queryParams.dictType"
          :placeholder="$tr('dict.placeholderType')"
          clearable
          size="small"
          style="width: 240px"
          @keyup.enter.native="handleQuery"
      ...
      <el-form-item :label="$tr('dict.status')" prop="status">
        <el-select
          v-model="queryParams.status"
          :placeholder="$tr('dict.placeholderStatus')"
          clearable
          size="small"
          style="width: 240px"
        >
      ...
      <el-form-item :label="$tr('dict.time')">
        <el-date-picker
          v-model="dateRange"
          size="small"
          style="width: 240px"
          ...
          type="daterange"
          range-separator="-"
          :start-placeholder="$tr('dict.startDate')"
          :end-placeholder="$tr('dict.endDate')"
        ></el-date-picker>
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column :label="$tr('dict.id')" align="center" prop="dictId" />
      <el-table-column :label="$tr('dict.name')" align="center" prop="dictName" :show-overflow-tooltip="true" />
      <el-table-column :label="$tr('dict.type')" align="center" :show-overflow-tooltip="true">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item :label="$tr('dict.name')" prop="dictName">
          <el-input v-model="form.dictName" :placeholder="$tr('dict.placeholderName')" />
        </el-form-item>
        <el-form-item :label="$tr('dict.type')" prop="dictType">
          <el-input v-model="form.dictType" :placeholder="$tr('dict.placeholderType')" />
        </el-form-item>
        <el-form-item :label="$tr('dict.status')" prop="status">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        dictName: [
          { required: true, message: this.$tr('dict.nameRequired'), trigger: "blur" }
        ],
        dictType: [
          { required: true, message: this.$tr('dict.typeRequired'), trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    handleAdd() {
      this.reset();
      this.open = true;
      this.title = this.$tr('dict.addTitle');
    },
    // 多选框选中数据
    ...
    handleUpdate(row) {
      ...
      getType(dictId).then(response => {
        ...
        this.open = true;
        this.title = this.$tr('dict.editTitle');
      });
    },
    /** 提交按钮 */
    submitForm: function() {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm(this.$tr('dict.deleteConfirm', { ids: dictIds })).then(function() {
    ...
    handleRefreshCache() {
      refreshCache().then(() => {
        this.$modal.msgSuccess(this.$tr('dict.refreshSuccess'));
      });
    }
  }
};
