<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="Task" prop="jobName">
        <el-input
      ...
      <el-form-item label="Group" prop="jobGroup">
        <el-select v-model="queryParams.jobGroup" placeholder="Please choose task group" clearable size="small">
          <el-option
      ...
      <el-form-item label="Status" prop="status">
        <el-select v-model="queryParams.status" placeholder="Please choose task status" clearable size="small">
          <el-option
    ...
    <el-table v-loading="loading" :data="jobList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="Expression" align="center" prop="cronExpression" :show-overflow-tooltip="true" />
          ...
          <el-dropdown size="mini" @command="(command) => handleCommand(command, scope.row)" v-hasPermi="['monitor:job:changeStatus', 'monitor:job:query']">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="handleRun" icon="el-icon-caret-right"
                v-hasPermi="['monitor:job:changeStatus']">Once</el-dropdown-item>
              <el-dropdown-item command="handleView" icon="el-icon-view"
                v-hasPermi="['monitor:job:query']">Details</el-dropdown-item>
              <el-dropdown-item command="handleJobLog" icon="el-icon-s-operation"
                v-hasPermi="['monitor:job:query']">Log</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row>
            ...
            <el-form-item prop="invokeTarget">
              <span slot="label">
                ...
                <el-tooltip placement="top">
                  <div slot="content">
                    Bean调用示例：ryTask.GMParams('ry')
                    <br />Class类调用示例：com.gym.quartz.task.RyTask.GMParams('ry')
          ...
          <el-col :span="24">
            <el-form-item label="executive strategy" prop="misfirePolicy">
              <el-radio-group v-model="form.misfirePolicy" size="small">
                <el-radio-button label="1">immediate</el-radio-button>
                <el-radio-button label="2">once</el-radio-button>
                <el-radio-button label="3">non-execution</el-radio-button>
              </el-radio-group>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="Concurrent" prop="concurrent">
              <el-radio-group v-model="form.concurrent" size="small">
                ...
                <el-radio-button label="1">Banned</el-radio-button>
              </el-radio-group>
            </el-form-item>
          </el-col>
          <el-col :span="12">
