<template>
  <div class="app-container">
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
      ...
      <el-table-column label="Place" align="center" prop="loginLocation" :show-overflow-tooltip="true" />
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('Are you sure to delete the entry with access number "' + infoIds + '"? ').then(function() {
    ...
    /** 清空按钮操作 */
    handleClean() {
      this.$modal.confirm('Confirm to clear all login log entries?').then(function() {
